# Contributing to the Zika Hackathon repo  
  
## GitHub
### Create GitHub account  
1. Create a GitHub account and log in through: https://github.com
2. Go to Zika Hackathon Repo: https://github.com/cloudera-cares-austin/zika-hackathon
3. On the upper right corner, click on **Fork**.  
   **You have now forked the zika hachathon repo into your github account.**  
  
  ***
  
### Contributing to the Zika Hackathon Project from GitHub  
...
4. To merge changes into the original repo, a *Pull Request* must be initiated by you from your fork.  
     ...
     + Owners of the Zika Hackathon repo will verify and merge your changes to the original repo
...
### Configure Git locally (using Windows)  
  ...
  You must have a GitHub account active and the forked zika hackathon repo in your account.  
...
4. Clone your fork locally:  
     + `git clone https://github.com/YOUR_USERNAME/zika-hackathon.git` <-- you are cloning *your* fork.  
     + Within your current directory, a new directory will be created locally. This is your cloned fork.  
  
  ***
  
### Contributing to the Zika Hackathon Project from Git  
...
### Updating your local clone and GitHub fork: Syncing
  To update your clone, you must sync your fork by fetching the updated Zika Hackathon repo to update your local clone and then pushing the updated clone to your GitHub fork:  
  
1. Open Git Bash
2. Change directory to your local fork:  
     + `git remote -v` <--your URL for will show as "original"  
     + `git remote add upstream https://github.com/cloudera-cares-austin/zika-hackathon.git` <--the original repo will show as "upstream"  
